...
[`VecMathOptInterface.Bridges.map_set`](@ref),
[`VecMathOptInterface.Bridges.map_function`](@ref).
...
[`VecMathOptInterface.Bridges.inverse_map_set`](@ref),
[`VecMathOptInterface.Bridges.inverse_map_function`](@ref),
[`VecMathOptInterface.Bridges.adjoint_map_function`](@ref) and
[`VecMathOptInterface.Bridges.inverse_adjoint_map_function`](@ref).
